...
As a new user I want to be able to create an account to secure my data
As a user I want to be able to log in to access my account
As a user I want to reset my password to recover access to my account
As a user I want to change my password to keep my account secure
As a user I want to edit my profile information to keep my account up to date
As a user I want to be able to connect through SSO (Future)
As a user I want to set a 2FA to secure my account (Future)

---

## Boards

As an owner I want to create a board to organise my projects
As an owner I want to be able to create multiple boards to organise my projects/ideas
As an owner I want to be able to assign users to a board
As an owner I want to be able to remove users from a board to secure my application
As an owner I want to be able to create roles to define permissions on my board
As an owner I want to be able to assign roles to users to control what they can do
As an owner I want to configure permissions per role to adapt the board to my use case
...
As a user I want to create cards to display my idea(s) if my role allows it
...
As an owner or admin I want to create tags to categorise cards on my board
As an owner or admin I want to edit a tag to rename or recolor it
As an owner or admin I want to delete a tag to keep the tag list clean
